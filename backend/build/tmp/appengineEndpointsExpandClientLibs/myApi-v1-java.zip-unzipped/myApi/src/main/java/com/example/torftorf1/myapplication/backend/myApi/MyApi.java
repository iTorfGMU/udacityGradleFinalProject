 ...
 * on 2017-10-21 at 05:15:48 UTC 
 * Modify at your own risk.
 */

package com.example.torftorf1.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetAJoke getAJoke(java.lang.Integer val) throws java.io.IOException {
    GetAJoke result = new GetAJoke(val);
    initialize(result);
    return result;
  }

  public class GetAJoke extends MyApiRequest<com.example.torftorf1.myapplication.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "mybean/{val}";
     ...
     * @since 1.13
     */
    protected GetAJoke(java.lang.Integer val) {
      super(MyApi.this, "GET", REST_PATH, null, com.example.torftorf1.myapplication.backend.myApi.model.MyBean.class);
      this.val = com.google.api.client.util.Preconditions.checkNotNull(val, "Required parameter val must be specified.");
    }
    ...
    public GetAJoke setVal(java.lang.Integer val) {
      this.val = val;
      return this;
    }
  ...
  public class SayHi extends MyApiRequest<com.example.torftorf1.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.torftorf1.myapplication.backend.myApi.model.MyBean.class);
